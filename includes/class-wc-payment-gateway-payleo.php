...
class WC_Gateway_MundoPagos extends WC_Payment_Gateway {
 ...
 // 
	...
	public function process_payment( $order_id ) {
		...
		// print_r ($order . "\n");
		// $token = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..gPqvN9AdKx6K4unZyMOqjlBcODhJuGvEclZ0mOyvx9kUGF8N6dP-tdR73fgRL8ndS4EeayiczsONC0Knucqtlcf4j4cG-gysHMnM67WjERjPXKy9qDqJ5jSQmd6M48br0usFH3nsx1zWaYT1g8uPeZPX7lLrZlwAStm5TpeeSKaHfxAN6wwesvweQoIxN6kpmrLAT0z_OX7c0ucqY3Z5Bp3rrbGk08jA_avX27DGs5nH9zkzKArmiFdtRubm3ndFqjpQtP48rL4tGQYFuTxdvIGrXmW5lXw6zED4_51a_gTac2UY9uGLzQkprvwiHwyrqw2vrbEAThdUSHrFJqzm-g";
		...
		$buyerinfo = new BuyerInfo($order_data['billing']['first_name'],$order_data['billing']['last_name'],'algo',$order_data['billing']['phone']
		,$order_data['billing']['email'],$order_data['billing']['address_1'],$order_data['billing']['country']);

		$firm = $this->id_agreement . ":" . $order->get_total() . ":" . 'camisa' . ":" . $order->get_currency() . ":" .$this->token;
		// print_r ($firm);
